    ...
    return (
      <>
        ...
        <div className="landing">
          ...
          <button className="signin-btn" onClick={() => {   try {     fetch("/api/track", {       method: "POST",       headers: { "Content-Type": "application/json" },       body: JSON.stringify({ event: "google_click", timestamp: new Date().toISOString() })     }).catch(() => {});   } catch {}   setShowGoogleWarning(true); }}>
